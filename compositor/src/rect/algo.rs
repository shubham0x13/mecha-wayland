//! Banded region set operations.
//!
//! Ported from Jay (`jay_algorithms::rect::region`), untagged (no damage tags yet).
...
pub type Container = SmallVec<[RectRaw; 1]>;
...
impl Band<'_> {
    fn can_merge_with(&self, next: &Band<'_>) -> bool {
